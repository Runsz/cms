...
class CMB2_Options_Hookup extends CMB2_Hookup {
	 ...
	 * (because settings_errors() already called in admin/options-head.php),
	...
	public function maybe_output_settings_notices() {
		...
		// The settings sub-pages will already have settings_errors() called in admin/options-head.php.
