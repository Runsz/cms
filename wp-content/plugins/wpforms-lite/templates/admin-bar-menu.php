...
<?php foreach ( $forms_data['forms'] as $key => $form ) : ?>
	<li id="admin-bar-wpforms-form-id-<?php echo esc_attr( $form['form_id'] ); ?>" class="menupop wpforms-menu-form<?php echo $key === 0 ? esc_attr( $has_notifications ) : ''; ?><?php echo $key === $last_key ? ' wpforms-menu-form-last' : ''; ?>">
		<div class="ab-item ab-empty-item" aria-haspopup="true"><span class="admin-bar-arrow" aria-hidden="true"></span><?php echo esc_html( $form['title'] ); ?></div>
		<div class="ab-sub-wrapper">
			<ul id="admin-bar-wpforms-form-id-<?php echo esc_attr( $form['form_id'] ); ?>-default" class="ab-submenu">
			<?php if ( ! empty( $form['edit_url'] ) ) : ?>
				<li id="admin-bar-wpforms-form-id-<?php echo esc_attr( $form['form_id'] ); ?>-edit">
			...
			<?php if ( ! empty( $form['entries_url'] ) ) : ?>
				<li id="admin-bar-wpforms-form-id-<?php echo esc_attr( $form['form_id'] ); ?>-entries">
			...
			<?php if ( ! empty( $form['survey_url'] ) ) : ?>
				<li id="admin-bar-wpforms-form-id-<?php echo esc_attr( $form['form_id'] ); ?>-survey">
