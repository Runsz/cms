...
class AIOWPSecurity_Spam_Menu extends AIOWPSecurity_Admin_Menu {
	...
	private function render_comment_spam() {
		...
		$aio_wp_security->include_template('admin/spam-prevention/comment-spam.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	private function render_comment_spam_ip_monitoring() {
		...
		$aio_wp_security->include_template('admin/spam-prevention/comment-spam-ip-monitoring.php', false, array('spammer_ip_list' => $spammer_ip_list, 'aiowps_feature_mgr' => $aiowps_feature_mgr, 'block_comments_output' => $block_comments_output));
	}
	...
	private function render_buddypress() {
		...
		$aio_wp_security->include_template('admin/spam-prevention/buddypress.php', false, array('AIOWPSecurity_Spam_Menu' => $this, 'aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	private function render_bbpress() {
		...
		$aio_wp_security->include_template('admin/spam-prevention/bbpress.php', false, array('AIOWPSecurity_Spam_Menu' => $this, 'aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
} //end class
