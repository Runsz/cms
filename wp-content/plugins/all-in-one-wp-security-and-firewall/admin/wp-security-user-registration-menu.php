...
class AIOWPSecurity_User_Registration_Menu extends AIOWPSecurity_Admin_Menu {
	...
	*/
	...
	private function render_manual_approval() {
		...
		$aio_wp_security->include_template('admin/user-registration/manual-approval.php', false, array('user_list' => $user_list, 'aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	private function render_registration_captcha() {
		...
		$aio_wp_security->include_template('admin/user-registration/registration-captcha.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	private function render_registration_honeypot() {
		...
		$aio_wp_security->include_template('admin/user-registration/registration-honeypot.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
} //end class
