...
class AIOWPSecurity_User_Login_Menu extends AIOWPSecurity_Admin_Menu {
	...
	*/ 
	...
	private function render_login_lockout() {
		...
		$aio_wp_security->include_template('admin/user-login/login-lockout.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr, 'locked_ip_list' => $locked_ip_list, 'result' => $result));
	}
	...
	public function render_failed_login_records() {
		...
		$aio_wp_security->include_template('admin/user-login/login-records.php', false, array('failed_login_list' => $failed_login_list));
	}
	...
	private function render_force_logout() {
		...
		$aio_wp_security->include_template('admin/user-login/force-logout.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	public function render_account_activity_logs() {
		...
		$aio_wp_security->include_template('admin/user-login/account-activity-logs.php', false, array('acct_activity_list' => $acct_activity_list));
	}
	...
	public function render_logged_in_users() {
		...
		$aio_wp_security->include_template('admin/user-login/logged-in-users.php', false, array('user_list' => $user_list));
	}
	...
	public function render_additional() {
		...
		$aio_wp_security->include_template('admin/user-login/additional.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
