...
class AIOWPSecurity_Filescan_Menu extends AIOWPSecurity_Admin_Menu {
	...
	private function render_file_change_detect() {
		...
		$aio_wp_security->include_template('admin/scanner/file-change-detect.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	private function render_malware_scan() {
		...
		$aio_wp_security->include_template('admin/scanner/malware-scan.php', false, array());
	}
