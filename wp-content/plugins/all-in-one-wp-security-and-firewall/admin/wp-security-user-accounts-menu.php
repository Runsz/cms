...
class AIOWPSecurity_User_Accounts_Menu extends AIOWPSecurity_Admin_Menu {
	...
	private function render_wp_username() {
		...
		$aio_wp_security->include_template('admin/user-accounts/wp-username.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr, 'user_accounts' => $user_accounts, 'AIOWPSecurity_User_Accounts_Menu' => $this));
	}
	...
	private function render_display_name() {
		...
		$aio_wp_security->include_template('admin/user-accounts/display-name.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	private function render_password_tool() {
		...
		$aio_wp_security->include_template('admin/user-accounts/password-tool.php', false, array());
	}
