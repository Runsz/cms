...
class AIOWPSecurity_Misc_Options_Menu extends AIOWPSecurity_Admin_Menu {
	...
	private function render_copy_protection() {
		...
		$aio_wp_security->include_template('admin/miscellaneous/copy-protection.php', false, array());
	}
	...
	private function render_frames() {
		...
		$aio_wp_security->include_template('admin/miscellaneous/frames.php', false, array());
	}
	...
	private function render_user_enumeration() {
		...
		$aio_wp_security->include_template('admin/miscellaneous/user-enumeration.php', false, array());
	}
	...
	private function render_wp_rest_api() {
		...
		$aio_wp_security->include_template('admin/miscellaneous/wp-rest-api.php', false, array());
	}
