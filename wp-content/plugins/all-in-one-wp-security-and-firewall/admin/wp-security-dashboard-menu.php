...
class AIOWPSecurity_Dashboard_Menu extends AIOWPSecurity_Admin_Menu {
	...
	private function render_locked_ip() {
		...
		$aio_wp_security->include_template('admin/dashboard/locked-ip.php', false, array('locked_ip_list' => $locked_ip_list));
	}
	...
	private function render_permanent_block() {
		...
		$aio_wp_security->include_template('admin/dashboard/permanent-block.php', false, array('blocked_ip_list' => $blocked_ip_list));
	}
	...
	private function render_debug_logs() {
		...
		$aio_wp_security->include_template('admin/dashboard/debug-logs.php', false, array('debug_log_list' => $debug_log_list));
	}
	...
	private function render_premium_upgrade_tab() {
		...
		$aio_wp_security->include_template('admin/dashboard/may-also-like.php');
