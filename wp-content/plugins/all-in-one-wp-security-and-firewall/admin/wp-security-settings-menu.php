...
class AIOWPSecurity_Settings_Menu extends AIOWPSecurity_Admin_Menu {
	...
	private function render_general_settings() {
		...
		$aio_wp_security->include_template('admin/settings/general-settings.php', false, array());
	}
	...
	private function render_htaccess_file_operations() {
		...
		$aio_wp_security->include_template('admin/settings/htaccess-file-operations.php', false, array());
	}
	...
	private function render_wp_config_file_operations() {
		...
		$aio_wp_security->include_template('admin/settings/wp-config-file-operations.php', false, array());
	}
	...
	private function render_delete_plugin_settings_tab() {
		...
		$aio_wp_security->include_template('admin/settings/delete-plugin-settings.php', false, array());
	}
	...
	public function render_wp_version_info() {
		...
		$aio_wp_security->include_template('admin/settings/wp-version-info.php', false, array('aiowps_feature_mgr' => $aiowps_feature_mgr));
	}
	...
	public function render_settings_file_operations() {
		...
		$aio_wp_security->include_template('admin/settings/settings-file-operations.php', false, array());
	}
	...
	public function render_advanced_settings() {
		...
		$aio_wp_security->include_template('admin/settings/advanced-settings.php', false, array(
