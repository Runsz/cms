...
class AIOWPSecurity_Utility_Htaccess {
	...
	public static function getrules_deny_bad_query_strings() {
		...
		if ($aio_wp_security->configs->get_value('aiowps_deny_bad_query_strings') == '1') {
			...
			// removed localhost because It was giving 403 error while browsing the URL http://localhost/aios2/wp-login.php?redirect_to=http%3A%2F%2Flocalhost%2Faios2%2Fadmin%2F&reauth=1
